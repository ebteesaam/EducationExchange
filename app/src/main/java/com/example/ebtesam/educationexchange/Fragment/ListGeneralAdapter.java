...
public class ListGeneralAdapter extends ArrayAdapter<Book> {

    public ListGeneralAdapter(Context context, int resource) {
        super(context, resource);
    }


    public ListGeneralAdapter(Context context, int resource, List<Book> items) {
...
//    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.list_general, parent, false);
        }
