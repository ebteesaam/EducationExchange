...
public class MainActivityAdmin extends AppCompatActivity {
    ...
    TabLayout tabLayout;
    private Context mContext = MainActivityAdmin.this;
    ...
    private void initImageLoader(){
        UnvirsalImageLoader universalImageLoader = new UnvirsalImageLoader(MainActivityAdmin.this);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.profile_menu_admin, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.profile:
            Intent intent=new Intent(MainActivityAdmin.this,ProfilePage.class) ;
            startActivity(intent);
                return true;
            case R.id.search:
                Intent i=new Intent(MainActivityAdmin.this, SearchBook.class) ;
                startActivity(i);
                return true;

            case R.id.users:
                Intent in=new Intent(MainActivityAdmin.this, UserList.class) ;
                startActivity(in);
                return true;
