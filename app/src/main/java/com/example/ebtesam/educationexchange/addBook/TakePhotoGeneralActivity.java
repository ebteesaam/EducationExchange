...
public class TakePhotoGeneralActivity extends AppCompatActivity {
    ...
    public boolean checkPermissions(String permission){
        ...
        int permissionRequest= ActivityCompat.checkSelfPermission(TakePhotoGeneralActivity.this, permission);
...
//                }
                ...
                startActivity(intent);
                TakePhotoGeneralActivity.this.finish();
                return true;
        }
